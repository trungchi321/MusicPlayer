...
public class FolderFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mfAdapter = new FolderRecyclerAdapter(homeConfigInfo.getAllMusicFolders().getMusicFolders(), getContext());
    ...
    public void initializeHeaderImages(View v) {
        ...
        int numFolders = homeConfigInfo.getAllMusicFolders().getMusicFolders().size();
        MusicFolder mf1, mf2;
        if (numFolders == 0) {
            for (int i = 0; i < 10; i++) {
            ...
            mf1 = homeConfigInfo.getAllMusicFolders().getMusicFolders().get(0);
            ...
            mf1 = homeConfigInfo.getAllMusicFolders().getMusicFolders().get(0);
            mf2 = homeConfigInfo.getAllMusicFolders().getMusicFolders().get(1);
            for (int i = 0; i < Math.min(10, mf1.getLocalTracks().size()); i++) {
                imgLoader.DisplayImage(mf1.getLocalTracks().get(i).getPath(), imgView[i]);
            }
            if (mf1.getLocalTracks().size() < 10) {

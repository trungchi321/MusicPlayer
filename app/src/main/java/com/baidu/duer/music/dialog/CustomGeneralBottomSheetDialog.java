package com.baidu.duer.music.dialog;
...
import com.baidu.duer.music.MusicApplication;
import com.baidu.duer.music.R;
...
public class CustomGeneralBottomSheetDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (generalTrack.getType()) {
            MusicApplication.getImageLoader().DisplayImage(generalTrack.getLocalTrack().getPath(), generalSongImage);
            ...
            MusicApplication.getImageLoader().DisplayImage(generalTrack.getStreamTrack().getArtworkURL(), generalSongImage);

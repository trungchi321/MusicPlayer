package com.baidu.duer.music.notification;
...
public class AudioPlayerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equalsIgnoreCase("com.baidu.duer.music.ACTION_PLAY_PAUSE")) {
            try {
        ...
        } else if (action.equalsIgnoreCase("com.baidu.duer.music.ACTION_NEXT")) {
        ...
        } else if (action.equalsIgnoreCase("com.baidu.duer.music.ACTION_PREV")) {
            try {

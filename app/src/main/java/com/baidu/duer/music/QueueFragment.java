...
public class QueueFragment extends Fragment implements QueueRecyclerAdapter.OnDragStartListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        qAdapter = new QueueRecyclerAdapter(homeConfigInfo.getQueue().getQueue(), getContext(), this);
        ...
        ItemTouchHelper.Callback callback = new SimpleItemTouchHelperCallback(qAdapter,homeConfigInfo);
    ...
    public void onResume() {
        super.onResume();
        mLayoutManager2.scrollToPositionWithOffset(homeConfigInfo.getQueueCurrentIndex(), 0);
    }

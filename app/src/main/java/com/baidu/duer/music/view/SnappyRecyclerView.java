package com.baidu.duer.music.view;
...
//            handleActions();
    ...
    public void handleActions() {
        ...
        if (currentPosition > homeActivity.getHomeConfigInfo().getQueueCurrentIndex()) {
            getAdapter().notifyDataSetChanged();
            homeActivity.onQueueItemClicked2(currentPosition);
        } else if (currentPosition < homeActivity.getHomeConfigInfo().getQueueCurrentIndex()) {
            getAdapter().notifyDataSetChanged();
            homeActivity.onQueueItemClicked2(currentPosition);
        } else {
//            setTransparency();
    ...
    public void setTransparency() {
        ...
        Settings settings = homeActivity.getHomeConfigInfo().getSettings();
        if (settings != null) {

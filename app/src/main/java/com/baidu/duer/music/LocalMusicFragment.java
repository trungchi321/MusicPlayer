...
public class LocalMusicFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        homeConfigInfo = activity.getHomeConfigInfo();
        ...
        lv.addOnItemTouchListener(new ClickItemTouchListener(lv) {
            ...
            boolean onClick(RecyclerView parent, View view, int position, long id) {
                ...
                if (position >= 0) {
                    ...
                    int queueCurrentIndex = getPosition(HomeActivity.finalLocalSearchResultList.get(position));
                    homeConfigInfo.setQueueCurrentIndex(queueCurrentIndex);

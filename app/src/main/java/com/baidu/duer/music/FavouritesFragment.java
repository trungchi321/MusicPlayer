...
public class FavouritesFragment extends Fragment implements
    ...
    public void updateFavFragment() {
        if (homeConfigInfo.getFavouriteTracks().getFavourite().size() > 0) {
            UnifiedTrack ut = homeConfigInfo.getFavouriteTracks().getFavourite().get(0);
            if (ut.getType()) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fAdapter = new FavouriteTrackAdapter(homeConfigInfo.getFavouriteTracks().getFavourite(), this, getContext());
        ...
        playAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (homeConfigInfo.getFavouriteTracks().getFavourite().size() > 0) {
                    ...
                    for (int i = 0; i <homeConfigInfo.getFavouriteTracks().getFavourite().size(); i++) {
                        homeConfigInfo.getQueue().getQueue().add(homeConfigInfo.getFavouriteTracks().getFavourite().get(i));
                    }
        ...
        ItemTouchHelper.Callback callback = new SimpleItemTouchHelperCallback(fAdapter,homeConfigInfo);
